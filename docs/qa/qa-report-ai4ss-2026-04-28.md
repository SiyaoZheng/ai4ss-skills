...
|-----------|------|--------|--------------|
| Codebook Browser | `skills/codebook-parse/scripts/codebook_html.py` | ✅ PASS (after fix) | 1 HIGH |
| LaTeX Table Viewer | `skills/latex-tables/scripts/table_html.py` | ✅ PASS (after fix) | 1 HIGH, 1 LOW |
| Performance Report | `skills/r-performance/scripts/perf_html.py` | ✅ PASS | — |
