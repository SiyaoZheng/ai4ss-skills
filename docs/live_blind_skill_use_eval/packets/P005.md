...
Task: Audit whether a DID table, event-study figure, mechanism table, and draft result claim support the intended interpretation, and keep any manuscript working text disclosure-gated.
