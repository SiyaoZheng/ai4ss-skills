...
Task: Turn the rough topic into a first-pass autonomous research-factory chain. The chain should make the research object, design declaration, .aiss model, evidence/data gates, .aiss analysis readiness, .aiss analysis artifacts, and bounded claim handoff inspectable before any manuscript prose is written.
