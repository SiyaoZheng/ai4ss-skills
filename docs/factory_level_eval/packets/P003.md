...
Task: Turn verified literature evidence into a theory-mapping handoff. The chain should preserve source paper ids, proposed .aiss objects, rival or boundary conditions, observable implications, AI-use disclosure, and author decisions.
