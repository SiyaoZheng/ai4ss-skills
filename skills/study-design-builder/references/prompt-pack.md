...
```text
Build the first analysis plan for this selected route.
...
```text
Hand off this design brief to $research-analysis-runner.

Carry forward route_id, design_source, data_source, expected first outputs, interpretation boundary, and validation checks.
