...
| `data/raw/city_crosswalk.csv` | city name/id map | `city_name`, `city_id`, `city_code` |

Target output:

`data/processed/city_panel_analysis.csv`

## Stage Plan

| stage | script | output | validation |
|---|---|---|---|
| ingest | `scripts/10_ingest_city_sources.R` | `data/intermediate/source_inventory.csv` | file existence, column names |
| harmonize | `scripts/20_harmonize_city_ids.R` | `data/intermediate/city_sources_harmonized.csv` | duplicate key check |
| merge | `scripts/30_merge_city_panel.R` | `data/intermediate/city_panel_merged.csv` | `.aiss` merge checks |
| construct | `scripts/40_construct_variables.R` | `data/processed/city_panel_analysis.csv` | `.aiss` variable-provenance observations |
| audit | `scripts/50_audit_analysis_sample.R` | `.ai4ss/research_model.aiss` and `output/logs/row_loss_report.csv` | row-loss and missingness checks |
...
|---|---|---|---:|---:|---:|---:|---|---|---|---|---|
| raw_patents | data/raw/patents_city_year.csv | data/intermediate/patents_city_year.csv | 3420 | 3420 | 285 | 285 | 2012-2023 | 2012-2023 | read source | pass | no row loss |
| drop_missing_outcome | data/intermediate/city_panel_merged.csv | data/processed/city_panel_analysis.csv | 3420 | 3388 | 285 | 285 | 2012-2023 | 2012-2023 | 32 city-years lack patent_count | warn | review missingness |
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---|---|
| city_crosswalk | data/raw/patents_city_year.csv | data/raw/city_crosswalk.csv | city_code | 3420 | 285 | 3420 | 0 | 3 | 0 | review | output/logs/unused_city_names.csv |
| policy_timing | data/intermediate/patents_harmonized.csv | data/raw/policy_pilots.xlsx | city_id | 3420 | 265 | 240 | 3180 | 0 | 0 | keep | output/logs/never_treated_cities.csv |
| controls | data/intermediate/city_policy_panel.csv | data/raw/city_controls.csv | city_id;year | 3420 | 3440 | 3310 | 78 | 120 | 0 | repair | output/logs/missing_controls.csv |
