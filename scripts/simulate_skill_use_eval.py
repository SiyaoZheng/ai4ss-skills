...
CASES = (
    EvalCase(
        ...
        expected_artifacts=("sample_flow.csv", "merge_audit.csv", "variable_provenance.csv", "output/logs/build_panel.log"),
        expected_trace_markers=("row counts", "merge unmatched rows", "variable construction rule", "raw data untouched"),
        expected_validators=("validate_data_audits.py sample_flow", "validate_data_audits.py merge_audit"),
        no_skill=SimulatedOutput(
            condition="no_skill",
    ...
    EvalCase(
        ...
        expected_artifacts=("literature_matrix.csv", "literature_screening_log.md", "source_locators.csv"),
        expected_trace_markers=("DOI or source URL", "claim_source_locator", "verification_level", "included_in_synthesis"),
        expected_validators=("validate_literature_matrix.py",),
        no_skill=SimulatedOutput(
            condition="no_skill",
